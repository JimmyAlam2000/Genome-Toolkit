class genomeToolkit:
    ...
    def find_most_frequent_kmers(self, sequence, k_len):
        ...
        Parameters:
             sequence (str): he DNA string o search.
        ...
        for i in range(len(sequence) - k_len + 1):
            ...
            if kmer in kmer_frequencies:
                ...
                kmer_frequencies[kmer] = 1
        # 3. A variable to sore the maximum value in the dictionary
        highest_frequency = max(kmer_frequencies.values())

        #4. List comprehension/loop to scan the k-mer dictionary and return a list o k-mers
